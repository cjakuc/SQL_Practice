...
summary_df['Balance'] = summary_df['Balance'].map(u"\u0024{:,.0f}".format)
...
This is a report I have created to practice performing analysis on SQL databases. The data is for a fake DVD rental company and was downloaded from [here](https://www.postgresqltutorial.com/postgresql-sample-database/). I then locally hosted the database to do exploratory queries and analysis. The full project can be found [here](https://github.com/cjakuc/SQL_Practice).

My goal was to mimic real world business questions as best as possible and explore the data for answers and avenues for further analysis. You can check out more of my work on my [portfolio page](https://cjakuc.github.io/) or feel free to connect with me on [LinkedIn](https://www.linkedin.com/in/chrisjakuc/)!
...
The custom function needed a bit of editing, but I was able to calculate the current (as of the most recent payment on May 14th, 2007) balance of all 599 customers in the data. In aggregate, the customers have a total positive balance of approximately \$11,734.30. In other words, they have paid more than they owed. Without knowing more details about the business model of the company, it is difficult to tell if so many customers carrying a positive balance is expected. Conversely, the total amount owed by all customers is \$529.95.

Looking at the summary statistics table shown in Figure 13, we can learn more about the balances carried by the customers. The customers, on average, have a positive balance of nearly \$20. The largest positive balance is \$70.03 and the lowest balance is \$-24.92. 
